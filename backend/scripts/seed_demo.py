...
with transaction.atomic():
    ...
    um_unidad = g(UnidadMedida, denominacion='Unidad', codigo='UNI', gestion=GESTION_FISCAL)
    um_persona = g(UnidadMedida, denominacion='Persona', codigo='PER', gestion=GESTION_FISCAL)
    um_vivienda = g(UnidadMedida, denominacion='Vivienda', codigo='VIV', gestion=GESTION_FISCAL)
    um_km = g(UnidadMedida, denominacion='Kilometro', codigo='KM', gestion=GESTION_FISCAL)
    um_m2 = g(UnidadMedida, denominacion='Metro cuadrado', codigo='M2', gestion=GESTION_FISCAL)
    um_ha = g(UnidadMedida, denominacion='Hectarea', codigo='HA', gestion=GESTION_FISCAL)
    um_porcentaje = g(UnidadMedida, denominacion='Porcentaje', codigo='%', gestion=GESTION_FISCAL)
    um_litro = g(UnidadMedida, denominacion='Litro', codigo='LT', gestion=GESTION_FISCAL)
    um_tonelada = g(UnidadMedida, denominacion='Tonelada', codigo='TON', gestion=GESTION_FISCAL)
    um_servicio = g(UnidadMedida, denominacion='Servicio', codigo='SRV', gestion=GESTION_FISCAL)

    # Objeto del gasto (classificacion presupuestaria)
    og_111 = g(ObjetoGasto, codigo='111', denominacion='Personal activo', gestion=GESTION_FISCAL)
    og_112 = g(ObjetoGasto, codigo='112', denominacion='Personal pasivo', gestion=GESTION_FISCAL)
    og_121 = g(ObjetoGasto, codigo='121', denominacion='Bienes muebles e inmuebles', gestion=GESTION_FISCAL)
    og_122 = g(ObjetoGasto, codigo='122', denominacion='Materiales y suministros', gestion=GESTION_FISCAL)
    og_131 = g(ObjetoGasto, codigo='131', denominacion='Servicios personales', gestion=GESTION_FISCAL)
    og_132 = g(ObjetoGasto, codigo='132', denominacion='Servicios no personales', gestion=GESTION_FISCAL)
    og_211 = g(ObjetoGasto, codigo='211', denominacion='Inversión nueva', gestion=GESTION_FISCAL)
    og_212 = g(ObjetoGasto, codigo='212', denominacion='Mejoramiento', gestion=GESTION_FISCAL)
    og_311 = g(ObjetoGasto, codigo='311', denominacion='Transferencias y subvenciones', gestion=GESTION_FISCAL)
    og_321 = g(ObjetoGasto, codigo='321', denominacion='Rentas de capital', gestion=GESTION_FISCAL)

    # Fuente de financiamiento
    ff_111 = g(FuenteFinanciamiento, codigo='111', denominacion='Recursos del Tesoro Municipal', gestion=GESTION_FISCAL)
    ff_121 = g(FuenteFinanciamiento, codigo='121', denominacion='Impuesto Directo a los Hidrocarburos (IDH)', gestion=GESTION_FISCAL)
    ff_131 = g(FuenteFinanciamiento, codigo='131', denominacion='Coparticipacion Nacional', gestion=GESTION_FISCAL)
    ff_211 = g(FuenteFinanciamiento, codigo='211', denominacion='Credito externo', gestion=GESTION_FISCAL)
    ff_311 = g(FuenteFinanciamiento, codigo='311', denominacion='Donaciones', gestion=GESTION_FISCAL)

    # Organismo financiador
    of_gob = g(OrganismoFinanciador, codigo='GOB', denominacion='Gobierno Municipal', gestion=GESTION_FISCAL)
    of_bm = g(OrganismoFinanciador, codigo='BM', denominacion='Banco Mundial', gestion=GESTION_FISCAL)
    of_bid = g(OrganismoFinanciador, codigo='BID', denominacion='Banco Interamericano de Desarrollo', gestion=GESTION_FISCAL)
    of_caf = g(OrganismoFinanciador, codigo='CAF', denominacion='Corporacion Andina de Fomento', gestion=GESTION_FISCAL)
    of_kfw = g(OrganismoFinanciador, codigo='KFW', denominacion='KfW Alemania', gestion=GESTION_FISCAL)

    # Finalidad / Funcion
    ff_func_01 = g(FinalidadFuncion, codigo='01', denominacion='Gobierno general', gestion=GESTION_FISCAL)
    ff_func_02 = g(FinalidadFuncion, codigo='02', denominacion='Defensa y orden publico', gestion=GESTION_FISCAL)
    ff_func_03 = g(FinalidadFuncion, codigo='03', denominacion='Educacion', gestion=GESTION_FISCAL)
    ff_func_04 = g(FinalidadFuncion, codigo='04', denominacion='Salud', gestion=GESTION_FISCAL)
    ff_func_05 = g(FinalidadFuncion, codigo='05', denominacion='Prevision social', gestion=GESTION_FISCAL)
    ff_func_06 = g(FinalidadFuncion, codigo='06', denominacion='Vivienda y servicios comunales', gestion=GESTION_FISCAL)
    ff_func_07 = g(FinalidadFuncion, codigo='07', denominacion='Actividades economicas', gestion=GESTION_FISCAL)

    # Tipo de operacion
    to_servicio = g(TipoOperacion, codigo='SRV', denominacion='Servicio', gestion=GESTION_FISCAL)
    to_mantenimiento = g(TipoOperacion, codigo='MNT', denominacion='Mantenimiento', gestion=GESTION_FISCAL)
    to_obra = g(TipoOperacion, codigo='OBR', denominacion='Obra', gestion=GESTION_FISCAL)
    to_capacitacion = g(TipoOperacion, codigo='CAP', denominacion='Capacitacion', gestion=GESTION_FISCAL)
    to_estudio = g(TipoOperacion, codigo='EST', denominacion='Estudio', gestion=GESTION_FISCAL)
    to_equipamiento = g(TipoOperacion, codigo='EQP', denominacion='Equipamiento', gestion=GESTION_FISCAL)

    # Tipo de producto
    tp_servicio = g(TipoProducto, codigo='SRV', denominacion='Servicio publico', gestion=GESTION_FISCAL)
    tp_infra = g(TipoProducto, codigo='INF', denominacion='Infraestructura', gestion=GESTION_FISCAL)
    tp_cap = g(TipoProducto, codigo='CAP', denominacion='Capacitacion', gestion=GESTION_FISCAL)
    tp_estudio = g(TipoProducto, codigo='EST', denominacion='Estudio tecnico', gestion=GESTION_FISCAL)
    tp_equip = g(TipoProducto, codigo='EQU', denominacion='Equipamiento', gestion=GESTION_FISCAL)

    # Tipo de proyecto
    tp_inv = g(TipoProyecto, codigo='INV', denominacion='Inversion publica', gestion=GESTION_FISCAL)
    tp_mant = g(TipoProyecto, codigo='MAN', denominacion='Mantenimiento', gestion=GESTION_FISCAL)
    tp_mej = g(TipoProyecto, codigo='MEJ', denominacion='Mejoramiento', gestion=GESTION_FISCAL)

    # Tipos adicionales
    g(ClasificadorInstitucional, codigo='CLA-01', denominacion='Entidad principal', gestion=GESTION_FISCAL)
    g(RubroRecurso, codigo='RR-01', denominacion='Recursos propios', gestion=GESTION_FISCAL)
    g(RubroRecurso, codigo='RR-02', denominacion='Recursos transferidos', gestion=GESTION_FISCAL)
    g(EntidadTransferencia, codigo='ET-01', denominacion='Gobierno Central', gestion=GESTION_FISCAL)
    g(EntidadTransferencia, codigo='ET-02', denominacion='Gobierno Departamental', gestion=GESTION_FISCAL)
    g(TipoFinanciamiento, codigo='TF-01', denominacion='Financiamiento directo', gestion=GESTION_FISCAL)
    g(TipoFinanciamiento, codigo='TF-02', denominacion='Contraentrega', gestion=GESTION_FISCAL)
